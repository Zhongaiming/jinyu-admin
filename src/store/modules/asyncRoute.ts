...
import { asyncRoutes, constantRouter, asyncPublicRoutes } from '@/router/index';
import { generateDynamicRoutes } from '@/router/generator';
import { useProjectSetting } from '@/hooks/setting/useProjectSetting';
import { storage } from '@/utils/Storage';
import { MENUID } from '@/store/mutation-types';
    ...
    async generateRoutes(data) {
      ...
      if (unref(permissionMode) === 'BACK') {
        ...
        try {
          ...
          //
          accessedRouters = accessedRouters.concat(asyncPublicRoutes);
        } catch (error) {
          console.log(error);
        }
      } else {
