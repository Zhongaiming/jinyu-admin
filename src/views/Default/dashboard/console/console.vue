...
<script lang="ts" setup>
  ...
  import { random as Random } from 'lodash-es';
  ...
  onMounted(() => {
    ...
    const data = {
      //访问量
      visits: {
        dayVisits: Random(10000, 99999),
        rise: Random(10, 99),
        decline: Random(10, 99),
        amount: Random(99999, 999999),
      },
      //销售额
      saleroom: {
        weekSaleroom: Random(10000, 99999),
        amount: Random(99999, 999999),
        degree: Random(10, 99),
      },
      //订单量
      orderLarge: {
        weekLarge: Random(10000, 99999),
        rise: Random(10, 99),
        decline: Random(10, 99),
        amount: Random(99999, 999999),
      },
